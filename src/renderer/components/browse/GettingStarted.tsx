...
import { useSuggestedSources } from '@renderer/hooks/useSuggestedSources';
...
export function GettingStarted({
  ...
  const manifest = useSuggestedSources();
  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto px-6 py-6 space-y-6">
        ...
        {/* Source picker (UX-12) */}
        <SourcePicker manifest={manifest} onSourcesAdded={onSourcesAdded} />

        {/* Featured plugins (UX-13) */}
        <FeaturedPlugins manifest={manifest} onSelect={onSelectEntry} />
